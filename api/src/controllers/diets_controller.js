...
// const { getSpoonApi } = require("../controllers/recipe_controller.js");
const { API_KEY } = process.env;

//Funcion asincrona
const getAllDiets = async (req, res) => {
    const DietsApi = await axios.get(`https://api.spoonacular.com/recipes/complexSearch?number=60&addRecipeInformation=true&apiKey=${API_KEY}`);
